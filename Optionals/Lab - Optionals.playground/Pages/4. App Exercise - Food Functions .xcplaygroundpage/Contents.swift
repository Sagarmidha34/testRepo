...
func getAMealObject(mealLog: String)-> Meal?{
...
if let mealDetails = getAMealObject(mealLog: "Breakfast"){
    print(mealDetails)
}
else{
    print("Meal log has not been created yet")
}
/*:
...
func mealLog()->[String: Any]{
    if let mealDetails = UserDefaults.standard.dictionary(forKey: "mealLog"){
        return mealDetails;
    }
    else{
        return [String: Any]()
