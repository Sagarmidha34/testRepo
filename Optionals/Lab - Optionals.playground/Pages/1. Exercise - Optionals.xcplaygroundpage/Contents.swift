...
print(userAge)
print("Value of type optional must be unwrapped to value of type 'Int'")
...
print(userAge)
print("userAge's is nil because we have declared it optional Int so when we not pass any of the value then it will give nil as the answer")
/*:
